...
public class ContatosControle {
	...
	static {
		LISTA_CONTATOS.add(new Contato("1", "Ana Raquel", "31 90000 0000"));
		LISTA_CONTATOS.add(new Contato("2", "Maria", "37 90000 0000"));
		LISTA_CONTATOS.add(new Contato("3", "Vinícius", "31 90000 0000"));
		LISTA_CONTATOS.add(new Contato("4", "Renata", "31 90000 0000"));
		LISTA_CONTATOS.add(new Contato("5", "André", "62 90000 0000"));
